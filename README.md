...
- `Heartdisease.ipynb` - Jupyter Notebook for data analysis and model training
...
- **Logistic Regression** - A linear classification algorithm used as a baseline for binary heart disease prediction.
